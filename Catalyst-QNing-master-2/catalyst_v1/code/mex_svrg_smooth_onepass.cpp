...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    /* Define variables*/
    double *Y, *X, *W, *Nb_it,*Y_k,*Dualgap, L, Lips, lambda, theta, z, value,deriv,loss_value,epsilon,dualgap,update_parameter,deriv_tilde,kappa,deriv_norm,para1;
    ...
    else /* If Eps was specified, check that it is a real double scalar */
    ...
    do{
        ...
        if (lambda+kappa >0)
        {
            ...
            dualgap = deriv_norm; 
            /*printf("iteration %d ends with deriv_norm = %e \n", nb_it,deriv_norm);*/
        }
        nb_it++;
    }while(nb_it < 1);
    clock_t tEnd2=clock();
    
    /*printf("Full gradient: %.5fs, one pass: %.5fs \n", (double)(tEnd -tStart)/CLOCKS_PER_SEC,(double)(tEnd2 -tStart2)/CLOCKS_PER_SEC );*/
