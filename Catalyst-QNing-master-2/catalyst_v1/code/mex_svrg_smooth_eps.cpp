...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    /* Define variables*/
    double *Y, *X, *W, *Nb_it,*Y_k,*Dualgap, L, Lips, lambda, theta, value,deriv,loss_value,epsilon,dualgap,update_parameter,deriv_tilde,kappa,deriv_norm,para1;
    ...
    //printf("Inner loop starts: required eps = %f \n",eps_norm);
    nb_it = 0;
