function [param] = param_catalyst(delta, Xtrain, model , mu, lambda, algo, default)

%   Description: This function initialize the parameters for catalyst-svrg
%
%   Outputs:  
...
if default
    ...
    param.stop_criterion = 'onepass'; % Choice: 'onepass', 'absolute' or relative'
    param.warm_start = 3;   % Choice: 0,1,2,3
