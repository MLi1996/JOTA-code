...
%     Err_Catalyst(exp_time) = err_nested_Catalyst_hist(ceil(Itrmax^2/ritr_num_Catalyst),1);
%     Err_Catalyst_Screening(exp_time) = err_nested_Catalyst_Screening_hist(ceil(Itrmax^2/ritr_num_Catalyst_Screening),1);
% 
% end

% Err = ([Err_SVRG;Err_SVRG_Screening;Err_Catalyst;Err_Catalyst_Screening]);
