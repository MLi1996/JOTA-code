...
for i = 1 : Itrmax
    ...
    j = sample(i);
    ytemp = y(j) + sigma * A(j,:) * x;
    ytemp2 = max(0,ytemp-sigma*b(j));
...
semilogy(1:100:Itrmax,err_SASC_hist(1:100:Itrmax),1:100:Itrmax,err_nested_SGD_hist(1:100:Itrmax),...
    1:100:Itrmax,err_nested_SGDM_hist(1:100:Itrmax),1:100:Itrmax,err_SPDHG_hist(1:100:Itrmax));
legend('SASC-SGD','Nested-SGD','Nested-SGDM','SPDHG');
xlabel('Iterations');
